...
fieldlabels_default_units = {
    ...
    'TI': r'TI $[-]$',
    'TI_TKE': r'TI (TKE) $[-]$',
    'TI_pavg': f'TI planar-avg $[-]$',
    'TI_hor': f'TI Uhor $[-]$',
    'TI_TKE_Umag': f'TI (TKE; Umag) $[-]$',
    'TI_TKE_Uhor': f'TI (TKE; Uhor) $[-]$',
    ...
    'sigma_u_over_calc_u*': r'$\sigma_u/u_*$',
    'sigma_v_over_calc_u*': r'$\sigma_v/u_*$',
    'sigma_w_over_calc_u*': r'$\sigma_w/u_*$',
    'sigma_v_over_sigma_u': r'$\sigma_v/\sigma_u$',
    'sigma_w_over_sigma_u': r'$\sigma_w/\sigma_u$',
    'sigma_u': r'$\sigma_u$ [m/s]',
    'sigma_v': r'$\sigma_v$ [m/s]',
    'sigma_w': r'$\sigma_w$ [m/s]',
